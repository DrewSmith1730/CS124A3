...
#ifndef CS124_SPLAYTREE_H
#define CS124_SPLAYTREE_H
...
private:
    ...
    // added dep as a parameter
    // Helper recursive function to find a value in the tree.
    bool find(const Comparable &c, SplayNode* &n, int* dep) {
        if (n == nullptr) {
...
public:
    ...
    bool find(const Comparable &c, int* dep) {
        // calls private helper function
